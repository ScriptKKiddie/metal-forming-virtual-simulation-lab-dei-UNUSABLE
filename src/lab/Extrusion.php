...
&nbsp;<object id="player" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" 
	   name="player" width="460" height="280"> 
		<param name="movie" value="player.swf" /> 
		<param name="allowfullscreen" value="true" /> 
<param name="wmode" value="transparent"/>		<param name="allowscriptaccess" value="always" /> 
		<param name="flashvars" value="file=EXTRUSION/Ex_pipe.mp4&repeat=always&image=images/Extrusion/TExtru_cold.gif"/> 
		<embed 
			wmode="transparent"
			...
			flashvars="file=EXTRUSION/Ex_pipe.mp4&repeat=always&image=images/Extrusion/TExtru_cold.gif"/> 
	</object>&nbsp;&nbsp;
	<object id="player" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" 
	   name="player" width="460" height="280"> 
		<param name="movie" value="player.swf" /> 
		<param name="allowfullscreen" value="true" /> 
<param name="wmode" value="transparent"/>		<param name="allowscriptaccess" value="always" /> 
		<param name="flashvars" value="file=EXTRUSION/Ex_solid.mp4&repeat=always&image=images/Extrusion/TExtru_hot.gif"/> 
		<embed 
			wmode="transparent"
			type="application/x-shockwave-flash"
			id="player2"
			...
			allowscriptaccess="always" 
			allowfullscreen="true"
			flashvars="file=EXTRUSION/Ex_solid.mp4&repeat=always&image=images/Extrusion/TExtru_hot.gif"/> 
	</object>
	<br><br>
