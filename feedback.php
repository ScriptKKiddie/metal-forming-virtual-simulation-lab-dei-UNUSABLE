...
<td><a href="Google_Analytics/AudienceOverview.pdf" title="Google Analytic" target="_blank">1. Audience Overview</td></tr>
<tr>
<td>B) College/Company with place:<img src="images/arsterix.gif"></td>
<td><input type="text" size="50px" name="deptName"></td><td>&nbsp;&nbsp;&nbsp;</td>
<td><a href="Google_Analytics/Continent.pdf" title="Google Analytic" target="_blank">2. Continent Report</td></tr>
<tr>
<td>C) Class with Semester / Designation:<img src="images/arsterix.gif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td><input type="text" name="class" size="50"></td><td>&nbsp;&nbsp;&nbsp;</td>
<td><a href="Google_Analytics/Country.pdf" title="Google Analytic" target="_blank">3. Country Report</td></tr>
<tr>
<td>D) Email ID:<img src="images/arsterix.gif"></td>
<td><input type="text" name="email" size="50"></td><td>&nbsp;&nbsp;&nbsp;</td>
<td><a href="Google_Analytics/City.pdf" title="Google Analytic" target="_blank">4. City Report</td></tr>
</table><br />
<table border="0"><tr>
